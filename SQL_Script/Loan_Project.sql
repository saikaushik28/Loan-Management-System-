...
create table customer_income_grade select *,case
...
create table customer_info select *,case
...
delete from cibil_table where loan_amount  = 'Loan Still Processing' or cibil_score_status ='Reject Customers (Loan cannot apply)';
 ...
 create table loan_cibilscore_status_details select c.*,
s.loan_amount,s.cibil_score,s.cibil_score_status from customer_info c  join cibil_table s on c.loan_id=s.loan_id ; 
...
--
 create table customer_interest_analysis select *,((interest_percentage/100) * loan_amount) as mon_interest_amt, ((interest_percentage/100) * loan_amount)*12 as ann_interest_amt,
